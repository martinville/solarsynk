...
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "V", "friendly_name": "Battery Charge Voltage"}, "state": "'"$battery_chargevolt"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_battery_chargevolt | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "A", "friendly_name": "Battery Current"}, "state": "'"$battery_current"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_battery_current | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "V", "friendly_name": "Battery Discharge Voltage"}, "state": "'"$battery_dischargevolt"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_battery_dischargevolt | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "W", "friendly_name": "Battery Power"}, "state": "'"$battery_power"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_battery_power | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "%", "friendly_name": "Battery SOC"}, "state": "'"$battery_soc"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_battery_soc | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "°C", "friendly_name": "Battery Temp"}, "state": "'"$battery_temperature"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_battery_temperature | jq -r '.entity_id'
...
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "V", "friendly_name": "Battery Voltage"}, "state": "'"$battery_voltage"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_battery_voltage | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "kWh", "friendly_name": "Daily Battery Charge"}, "state": "'"$day_battery_charge"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_day_battery_charge | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "kWh", "friendly_name": "Daily Battery Discsharge"}, "state": "'"$day_battery_discharge"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_day_battery_discharge | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "kWh", "friendly_name": "Daily Grid Export"}, "state": "'"$day_grid_export"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_day_grid_export | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "kWh", "friendly_name": "Daily Grid Import"}, "state": "'"$day_grid_import"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_day_grid_import | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "kWh", "friendly_name": "Daily Load Energy"}, "state": "'"$day_load_energy"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_day_load_energy | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "kWh", "friendly_name": "Daily PV energy"}, "state": "'"$day_pv_energy"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_day_pv_energy | jq -r '.entity_id'
...
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "V", "friendly_name": "Inverter Voltage"}, "state": "'"$inverter_voltage"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_inverter_voltage | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "A", "friendly_name": "Load Current"}, "state": "'"$load_current"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_load_current | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "Hz", "friendly_name": "Load Freq"}, "state": "'"$load_frequency"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_load_frequency | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "W", "friendly_name": "Load Power"}, "state": "'"$load_power"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_load_power | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "W", "friendly_name": "Load Total Power"}, "state": "'"$load_totalpower"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_load_totalpower | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "V", "friendly_name": "Load Voltage"}, "state": "'"$load_voltage"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_load_voltage | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "A", "friendly_name": "PV1 Current"}, "state": "'"$pv1_current"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_pv1_current | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "W", "friendly_name": "PV1 Power"}, "state": "'"$pv1_power"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_pv1_power | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "V", "friendly_name": "PV1 Voltage"}, "state": "'"$pv1_voltage"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_pv1_voltage | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "A", "friendly_name": "PV2 Current"}, "state": "'"$pv2_current"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_pv2_current | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "W", "friendly_name": "PV2 Power"}, "state": "'"$pv2_power"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_pv2_power | jq -r '.entity_id'
curl -s -X POST -H "Authorization: Bearer $HA_LongLiveToken" -H "Content-Type: application/json" -d '{"attributes": {"unit_of_measurement": "V", "friendly_name": "PV2 Voltage"}, "state": "'"$pv2_voltage"'"}' http://$Home_Assistant_IP:8123/api/states/sensor.solarsynk_pv2_voltage | jq -r '.entity_id'
